...
type FakeClient struct {
	...
	NewLogCacheClientStub        func() *client.Client
...
func (fake *FakeClient) NewLogCacheClient() *client.Client {
...
func (fake *FakeClient) NewLogCacheClientCalls(stub func() *client.Client) {
	fake.newLogCacheClientMutex.Lock()
	defer fake.newLogCacheClientMutex.Unlock()
	fake.NewLogCacheClientStub = stub
}

func (fake *FakeClient) NewLogCacheClientReturns(result1 *client.Client) {
	fake.newLogCacheClientMutex.Lock()
	defer fake.newLogCacheClientMutex.Unlock()
...
func (fake *FakeClient) NewLogCacheClientReturnsOnCall(i int, result1 *client.Client) {
	fake.newLogCacheClientMutex.Lock()
	defer fake.newLogCacheClientMutex.Unlock()
	fake.NewLogCacheClientStub = nil
